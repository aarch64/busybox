...
# *.utf8 locale is necessary for toolchain building. So we generate en_US.utf8 without checking
# see https://github.com/maximeh/buildroot/blob/master/support/dependencies/dependencies.sh#L190 
